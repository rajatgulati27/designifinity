...
(function ($) {
    ...
    $(document).ready(function () {
        $(".workCategories .categoryGroup .category figure").click(function () {
            ...
            $(this).parent().parent().parent().addClass("activeParent");
        ...
        $(".workCategories .categoryGroup .category span.close").click(function () {
            ...
            $(this).parent().parent().parent().removeClass("activeParent");
...
var AnimateBrand = function ($main) {
    ...
    this.timeLine = new TimelineMax({
        ...
        .to(this.pathobj, 1, {
            ...
            onUpdateScope: this,
            onUpdate: function () {
                this.heartPath.style.strokeDasharray = [this.pathobj.length, this.pathobj.pathLength]
                    .join(' ');
                ...
                this.pen.css('transform', 'translate(' + coords.x + 'px, ' + coords.y +
                    'px) rotate(45deg)');
